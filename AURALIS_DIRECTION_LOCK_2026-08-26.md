# Auralis Digital Direction Lock — 2026-08-26
...
- click-to-call and contact / quote-request flow;
- review, gallery, and trust sections;
- basic metadata / local-search fundamentals;
- analytics where appropriate;
- launch QA;
- optional ongoing care or managed-presence support.

Current working price hypotheses:

- **Business Digital Front Door:** starting around **$995**;
...
launch / handoff
    ↓
real testimonial or review when earned
    ↓
referral
```
...
Lucid remains an active owned commerce asset.

Current doctrine:

- keep the existing store and catalog operational;
- stop broad undifferentiated product expansion;
- focus distribution on existing stronger product families and personalization opportunities;
- treat customer acquisition / distribution as the main commerce constraint until sales evidence says otherwise;
- measure sessions, product views, add-to-cart, checkout, orders, net sales, refunds, and contribution economics;
- let real demand decide which products receive more creative work.

Printify remains fulfillment infrastructure, not the strategy engine.

## Lucid Visuals

Lucid Visuals is an approved active digital-product experiment.
...
It is not the primary acquisition engine.
...
Promotion requires external evidence such as:
...
Where older Auralis documents conflict with this file, this file wins until another explicit dated direction lock supersedes it.
