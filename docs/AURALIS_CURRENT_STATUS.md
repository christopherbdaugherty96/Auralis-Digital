...
7. Contact qualified prospects using the `leads/` materials.
8. Close and deliver one real client, even if discounted.
9. Publish one live URL, testimonial, and case study.
10. Offer the care plan at handoff.
...
Then execute outreach and deliver the first client. One completed real client will solve more trust problems than another round of website polish.
