...
export const shopProducts: ShopProduct[] = [
  ...
  },
  {
    ...
    shortDescription: "“Depth” wraps a surreal all-over artwork around a custom cut-and-sewn pullover hoodie — built for bold visual impact, warmth, and everyday comfort.",
    detailDescription: "“Depth” wraps a surreal all-over artwork around a custom cut-and-sewn pullover hoodie — built for bold visual impact, warmth, and everyday comfort.\n\n.: 100% polyester, medium weight (7.4 oz/yd²)\n\n.: Custom cut and sewn for edge-to-edge print coverage\n\n.: Classic unisex fit with front kangaroo pocket and drawstring hood\n\n.: Assembled in the USA from globally sourced parts\n\n.: Care: machine wash cold, tumble dry low; no bleach, iron, or dry cleaning\n\nMade to order by Lucid Creations — produced after purchase (usually 2–5 business days) and shipped with tracking.",
